...
class ViewController: UITableViewController {
    ...
    var improvementsArray = [(iid: String, name: String, description: String,lifecyclePhase: String)]()
    ...
    func parseImprovements() {
        do {
            ...
            for improvements in improvementsSource.componentsSeparatedByString(";") {
                ...
                improvementsArray.append((iid: improvement[0], name: improvement[1], description: improvement[2],lifecyclePhase: improvement[3]))
            }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = improvementsArray[indexPath.row].name
        cell.detailTextLabel?.text = improvementsArray[indexPath.row].description
