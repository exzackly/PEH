...
for i in range(21):
	...
	urllib.request.urlopen('http://exzackly7.com/PEH/addUser.php?name=' + name + '&type=' + type + '&email=' + email + '&pwd=' + password)
...
for i in range(100):
	...
	urllib.request.urlopen('http://exzackly7.com/PEH/addLike.php?uid=' + str(uid) + '&iid=' + str(iid))
...
for i in range(100):
	...
	urllib.request.urlopen('http://exzackly7.com/PEH/addComment.php?uid=' + str(uid) + '&iid=' + str(iid) + '&cmt=' + comment)
